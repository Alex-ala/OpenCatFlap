...
#define OCF_SERVO_IN_PIN 5
#define OCF_SERVO_IN_LOCKED 90
#define OCF_SERVO_IN_UNLOCKED 120
#define OCF_SERVO_OUT_PIN 14
#define OCF_SERVO_OUT_LOCKED 90
#define OCF_SERVO_OUT_UNLOCKED 60

#define OCF_MOTION_INSIDE_PIN 6
#define OCF_MOTION_OUTSIDE_PIN 13
#define OCF_MOTION_DELAY 200
#define OCF_MOTION_THRESHOLD 0

#define OCF_FLAPIR_OUTSIDE_PIN 12
#define OCF_FLAPIR_INSIDE_PIN 7

#define OCF_RFID_OUTSIDE_PIN 44
#define OCF_RFID_INSIDE_PIN 18
